...
- `Final_2011_2020_Medicaidelig.csv`: This file contains the merged and cleaned data, with only relevant variables retained, included for reference only. It was generated by running`Data Cleaning.py`.
- `individual_level_with_category_indicators.csv`: This is the cleaned individual-level dataset, included for reference only. It was also generated by running `Data Prepare.py`.
